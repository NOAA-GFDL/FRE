# $Id: hsmput.mk,v 1.1.2.14.2.1 2013/03/27 23:43:58 afy Exp $
...
#the dot variables
.LOW_RESOLUTION_TIME: $(PTMPROOT)/% $(WORKROOT)/%.cpio $(ARCHROOT)/%.tar
.PRECIOUS: $(PTMPROOT)/% $(WORKROOT)/%.cpio $(ARCHROOT)/%.tar
.SUFFIXES:
