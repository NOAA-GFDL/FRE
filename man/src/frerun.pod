...
Compress model output.  I<< <STRING> >> can be one of I<ascii>,
I<restart>, I<history> or I<all>.
...
=item B<-R>, B<--remote-user> B<< <STRING> >>
...
Partition I<< <STRING> >> to use for model runs.  Default: depends on
site.

=item B<-q>, B<--queue> I<< <STRING> >>

Queue STRING to use for model runs.  Default: depends on site.
